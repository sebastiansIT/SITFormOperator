...
/**
 * The built in class HTMLElement.
 * @external HTMLElement
 * @see {@link https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement|MDN Web Docs}
 */

/**
 * The built in class HTMLDetailsElement.
 * @external HTMLDetailsElement
 * @see {@link https://developer.mozilla.org/en-US/docs/Web/API/HTMLDetailsElement|MDN Web Docs}
 */

/**
 * The built in class CustomEvent.
